public class Horseman extends Unit{
    public Horseman(String name, int health, int attack_force, int attack_range, int shield, int moving_range, double available_moving_range, int cost, char prev_place,  char place) {
